...
import styles from "../punam/Order.module.css";


export const Checkout = () => {
    let checkoutData = JSON.parse(localStorage.getItem("cartProducts"))
                    ...
                    {checkoutData.map((item) => {
                        return (
                            <div className={styles.itemdiv}>
                                <img src={item.itemImg} style={{height:"300px", width:"200px"}} />
